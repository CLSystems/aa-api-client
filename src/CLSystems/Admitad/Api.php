...
namespace CLSystems\Admitad;

use CLSystems\Admitad\Exception\ApiException;
use CLSystems\Admitad\Exception\Exception;
use CLSystems\Admitad\Exception\InvalidSignedRequestException;
...
class Api
{
	...
	public function authorizeByCredentials($clientId, $clientSecret, $scope)
	{
		$query = array(
			'client_id'  => $clientId,
